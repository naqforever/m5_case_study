...
@Component({
  selector: 'app-manager-content-layout',
  templateUrl: './manager-content-layout.component.html',
  styleUrls: ['./manager-content-layout.component.css']
})
export class ManagerContentLayoutComponent implements OnInit {
